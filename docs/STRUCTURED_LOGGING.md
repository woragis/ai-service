...
The AI service uses structured logging with `structlog` for consistent, searchable logs across all environments. Logs are automatically formatted as JSON in production and human-readable text in development.
...
- **File logging** - Optional file logging in development
...
4. **Use appropriate levels** - Match log level to severity
