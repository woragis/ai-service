...
- **GitHub Actions CI Workflow**: Automated testing on push and pull requests
  ...
  - Integration tests with external API providers
...
- **Integration Test Fixes**: Corrected stream endpoint assertions
...
- Improved integration test assertions for stream endpoints
- Enhanced test coverage reporting

### Fixed
- Fixed `pytest-asyncio` deprecation warning
- Fixed stream endpoint test assertions
