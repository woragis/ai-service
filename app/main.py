...
class ChatRequest(BaseModel):
    agent: Literal["economist", "strategist", "entrepreneur", "startup",
                   "cover_letter", "auto"] = Field(..., description="Agent persona or 'auto'")
...
class ContentGenerationRequest(BaseModel):
    type: Literal["profile", "experience", "skills",
                  "summary"] = Field(..., description="Type of content to generate")
